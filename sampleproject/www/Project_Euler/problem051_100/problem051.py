...
def problem_51() -> int:
    ...
    for max_digit in itertools.count(1):
        for rplc_digit in range(1, max_digit):
            check_list = get_prime_digit_replacements_check_list(max_digit, rplc_char, rplc_digit)
...
def get_prime_digit_replacements_check_list(max_digit: int, rplc_char, rplc_digit: int) -> list:
    '''
    ...
    check_list = [num for num in itertools.product(pattern_list, repeat=max_digit) \
